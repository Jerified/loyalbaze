    ...
    <>
      <main className="lg:grid grid-cols-2 gap-8 items-center max-w-4xl mx-auto px-8 pt-6">
        <div className="text-center lg:text-start lg:place-items-center relative">
          ...
          <p className="pt-2 text-sm max-w-[22rem] md:max-w-lg lg:max-w-[24rem] mx-auto lg:m-0">
          ...
          <form action="" className="py-8 bg-[#1D2939] my-16 rounded-md">
            <div className=" flex flex-col gap-4 mx-auto px-6 lg:px-8">
              ...
              <textarea
                ...
                className=" bg-inherit border-2 w-full rounded-md py-1 px-2 pl-2 placeholder:text-[14px] caret-[linear-gradient(112.92deg,_#5404FF_18.35%,rgba(189,_59,_210,_0.94)_71.49%)] outline-none resize-none placeholder:text-white"
              />
