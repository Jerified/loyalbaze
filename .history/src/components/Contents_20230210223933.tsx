...
const Contents = () => {
  return (
    <div className="pt-8  pb-16">
      ...
      <div className="flex relative text-xm">
        <p className="bg-blue-500 rounded-full w-fit px-2 absolute -left-[24px]">G</p>
        <p className="bg-[#A75FD2] rounded-full w-fit px-2 ">O</p>
        <p className="bg-blue-500 rounded-full w-fit px-2">U</p>
        <p className="bg-[#A75FD2] rounded-full w-fit px-2">M</p>
      </div>
    </div>
  );
}
