          ...
          <form action="" className="py-8 bg-[#1D2939] my-16 rounded-md">
            ...
            <div className=" flex flex-col gap-4 w-[80%] md:w-[60%] lg:w-[100%] mx-auto lg:px-8">
              ...
              <textarea
                ...
                className=" bg-inherit border-2 w-full rounded-md py-1 px-2 pl-2 placeholder:text-[14px] caret-[linear-gradient(112.92deg,_#5404FF_18.35%,rgba(189,_59,_210,_0.94)_71.49%)] outline-none resize-non text"
              />
