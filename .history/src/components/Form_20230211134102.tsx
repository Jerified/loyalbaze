    ...
    <>
      <main className="lg:grid grid-cols-2 gap-8 items-center">
        <div className="text-center lg:text-start">
          ...
          <p className="pt-4 text-sm max-w-[22rem] md:max-w-lg lg:max-w-sm mx-auto">
        ...
        <form action="" className="py-6 bg-[#1D2939] mt-8 rounded-md">
          ...
          <div className=" flex flex-col gap-4 w-[80%] md:w-[60%] lg:w-[100%] mx-auto lg:px-8">
            ...
            <textarea name="" id="" cols="30" rows="10" placeholder='Drop a message...' className=" bg-inherit border-2 w-full rounded-md py-1 px-2 pl-2 placeholder:text-[14px] caret-[linear-gradient(112.92deg,_#5404FF_18.35%,rgba(189,_59,_210,_0.94)_71.49%)] outline-none"/>
          </div>
        </form>
      </main>
    </>
