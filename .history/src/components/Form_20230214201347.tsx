        ...
        <div className="text-center lg:text-start lg:place-items-center relative">
          <div className="lg:flex justify-start">
            <div className="grid place-items-center">
              <h1 className="font-semibold text-3xl tracking-wider">Priority Access</h1>
              <div className="">
                <svg
                  width="130"
                  height="70"
...
<path d="M20.25 2.25C19.25 11.0833 14.2 28.75 2 28.75" stroke="#175CE1" stroke-width="3.75" stroke-linecap="round"/>
<path d="M20.25 48C21.25 38.3333 26.3 19 38.5 19" stroke="#175CE1" stroke-width="3.75" stroke-linecap="round"/>
<path d="M20.25 2C21.25 7.66667 26.3 19 38.5 19" stroke="#175CE1" stroke-width="3.75" stroke-linecap="round"/>
<path d="M20.25 48C19.25 41.6667 14.2 29 2 29" stroke="#175CE1" stroke-width="3.75" stroke-linecap="round"/>
</svg>
