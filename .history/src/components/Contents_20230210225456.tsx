  ...
  return (
    <div className="pt-8  pb-16">
      ...
      <div className="flex relative text-sm">
        <p className="bg-blue-500 rounded-full w-fit px-[10px] py-[2px] absoolute relative left-3">
          G
        </p>
        <p className="bg-[#A75FD2] rounded-full w-fit px-[10px] py-[2px]  relative left-2">
          O
        </p>
        <p className="bg-blue-500 rounded-full w-fit px-[10px] py-[2px]">U</p>
