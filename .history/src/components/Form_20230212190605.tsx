  ...
  return (
    <>
      <main className="lg:grid grid-cols-2 gap-8 items-center">
        ...
        <div className="">
          <form action="" className="py-4 bg-[#1D2939] my-16 rounded-md">
           
            <div className=" flex flex-col gap-4 w-[80%] md:w-[60%] lg:w-[100%] mx-auto px-8">
                 <p className=" pb-4">Book a Consultation with us</p>
              <input
                type="text"
                className="input"
