  ...
  return (
    <div className="pt-8">
      ...
      <form action="" className="pt-8 grid place-items-center gap-4">
        <div className="w-[80%] md:w-[30%]  relative flex items-center">
          <input
            type="text"
        ...
        <div className="w-[80%] md:w-[30%]  relative flex items-center">
          <input
            type="text"
            className=" bg-inherit border-2 w-full rounded-md py-1 px-2 pl-7 placeholder:text-[14px] placeholder:pt-[-1] "
