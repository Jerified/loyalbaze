...
<path d="M3.5 4.8585C26.7327 3.78401 160.807 1.27686 171.613 4.8585C185.121 9.33556 39.9697 17.9315 32.6758 21.155C26.8406 23.7338 146.678 29.5718 153.702 30.2882C160.726 31.0045 70.2263 42.3583 71.3069 67" stroke="#4A3AFF" stroke-width="5.55173" stroke-linecap="round"/>
</svg>

                 <p className=" pb-4">Book a Consultation with sus</p>
              <input
                type="text"
                className="input"
