...
export default function Header() {
  return (
    <div className="flex justify-between px-8 sm:mx-auto items-center py-6 lg:pb-0 max-w-4xl mx-auto">
      <div className="text-xl font-semibold tracking-wider flex items-end justify-end">
        ...
        <div className="relative">
          <svg
            ...
            className="absolute bottom-2 right-[0.23rem]"
          >
            <path
      ...
      <button className="rounded-full">
        <div
          className="rounded-t-full overflow-hidden text-[0.7rem] bg-gradient-to-r from-[#5404FF]
       to-[rgba(189,_59,_210,_0.94)] p-[0.1rem]"
        >
          <div className="bg-[#121B27] px-3 py-[0.4rem]">
            <p className="font-semibold">Get Priority Access</p>
          </div>
        </div>
      </button>
    </div>
