  ...
  return (
    <div className="pt-8  pb-16">
      ...
      <div className="flex relative text-sm">
        <p className="bg-blue-500 rounded-full w-fit px-[10px] py-[2px] absolute -left-[24px]">
          G
        </p>
        <p className="bg-[#A75FD2] rounded-full w-fit px-[10px] py-[2px]">O</p>
        <p className="bg-blue-500 rounded-full w-fit px-[10px] py-[2px]  absolute inset-0 left-[24px]">
          U
        </p>
