...
const Contents = () => {
  return (
    <div className="pt-8  pb-16">
      ...
      <div className="flex">
        <p className="bg-blue-500 rounded-full w-fit px-2 overflow-hidden">G</p>
        <p className="bg-blue-700 rounded-full w-fit px-2 ml-[-10px]">O</p>
        <p className="bg-blue-500 rounded-full w-fit px-2">U</p>
        <p className="bg-blue-500 rounded-full w-fit px-2">M</p>
      </div>
    </div>
  );
}
