...
export default function Header() {
  return (
    <div className="flex justify-between px-8 sm:mx-auto items-center py-6 max-w-6xl mx-auto">
      ...
      <div className=""></div>
      <button className=" px-3 py-1 rounded-full border-gradient-[linear-gradient(112.92deg,_#5404FF_18.35%,rgba(189,_59,_210,_0.94)_71.49%)] text-sm bg-gradient-to-r from-[#5404FF] to-[rgba(189,_59,_210,_0.94)]">
       <p></p> Get Priority Access
      </button>
    </div>
  );
}
