  ...
  return (
    <div>
      <div
        ...
        "
      />
      <div className="lg:grid lg:grid-cols-3 text-center gap-3 text-sm py-3 lg:gap-0 items-center">
        ...
        <div className="flex justify-center items-center gap-2 order-3 lg:text-end">
