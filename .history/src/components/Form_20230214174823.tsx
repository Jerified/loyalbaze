...
const Form = () => {
  return (
    <>
      <main className="lg:grid grid-cols-2 gap-8 items-center max-w-6xl mx-auto px-8">
        <div className="text-center lg:text-start lg:place-items-center">
          ...
          <p className="pt-4 text-sm max-w-[22rem] md:max-w-lg lg:max-w-[20rem] mx-auto lg:m-0">
